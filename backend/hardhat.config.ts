...
// Support custom Sepolia RPC URL (PowerShell: $env:SEPOLIA_RPC_URL="...")
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: {
      ...
      chainId: 11155111,
      // Use custom RPC URL if provided, otherwise fallback to Infura
  ...
  solidity: {
    ...
    settings: {
      ...
      // Enable IR-based code generation to resolve "Stack too deep" errors
      viaIR: true,
      evmVersion: "cancun",
    },
  },
